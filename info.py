...
auth_grp = environ.get('AUTH_GROUP', '-1001650425054')
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None
AUTH_GROUPS = [int(ch) for ch in auth_grp.split()] if auth_grp else None
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1001918925906') 
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1001650425054')
...
VERIFY2_API = environ.get('VERIFY2_API', "8536db2963229d622d99d92d62b04cac053646f9")
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1001719548150')).split()]
